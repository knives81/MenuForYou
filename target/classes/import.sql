...
INSERT INTO `tb_menu` (`menu_name`,`USER`) VALUES ('ROOT','ADMIN');
...
INSERT INTO `TB_TYPEDISH`(`MENU_ID`,`ORDERDISPLAY`) VALUES (1,1);
...
INSERT INTO `TB_TYPEDISH`(`MENU_ID`,`ORDERDISPLAY`) VALUES (1,2);
...
INSERT INTO `TB_TYPEDISH`(`MENU_ID`,`ORDERDISPLAY`) VALUES (1,3);
...
INSERT INTO `TB_DISH`(`DISH_IMAGE_URL`,`DISH_NAME`,`DISH_PRICE`,`MENU_ID`,`DISH_TYPEDISH_ID`,`ORDERDISPLAY`) VALUES ('','Lasagne',15.00,1,1,4);
...
INSERT INTO `TB_DISH`(`DISH_IMAGE_URL`,`DISH_NAME`,`DISH_PRICE`,`MENU_ID`,`DISH_TYPEDISH_ID`,`ORDERDISPLAY`) VALUES ('','Panna Cotta',11.80,1,2,5);
...
INSERT INTO `tb_feedback` (`feedback_message`,`feedback_rating`,`feedback_dish_id`) VALUES ('Too salty',1,2);
INSERT INTO `tb_feedback` (`feedback_message`,`feedback_rating`,`feedback_dish_id`) VALUES ('Very good',4,2);



INSERT INTO `TB_SEQUENCENUMBER` (`ID`) VALUES (6);
INSERT INTO `TB_DISH`(`DISH_IMAGE_URL`,`DISH_NAME`,`DISH_PRICE``MENU_ID`,`DISH_TYPEDISH_ID`,`ORDERDISPLAY`) VALUES ('','Bistecca',25.00,1,2,6);
...
INSERT INTO `tb_feedback` (`feedback_message`,`feedback_rating`,`feedback_dish_id`) VALUES ('not bad',2,3);

INSERT INTO `TB_SEQUENCENUMBER` (`ID`) VALUES (7);
INSERT INTO `TB_INGREDIENT`(`MENU_ID`,`ORDERDISPLAY`) VALUES (1,7);
...
INSERT INTO `TB_INGREDIENT`(`MENU_ID`,`ORDERDISPLAY`) VALUES (1,8);
...
INSERT INTO `TB_INGREDIENT`(`MENU_ID`,`ORDERDISPLAY`) VALUES (1,9);
...
INSERT INTO `TB_INGREDIENT`(`MENU_ID`,`ORDERDISPLAY`) VALUES (1,10);
